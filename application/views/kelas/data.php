		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="pull-right">
					<a href="<?=base_url('kelas/add')?>" class="btn bg-purple btn-flat btn-sm"><i class="fa fa-plus"></i> Tambah Kelas</a>
					<button type="button" onclick="reload_ajax()" class="btn btn-flat btn-sm bg-maroon"><i class="fa fa-refresh"></i> Reload</button>
				</div>
			</div>
		</div>
    </div>
	<?=form_open('kelas/delete', array('id'=>'bulk'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/kelas/data.js"></script>
