        ...
        <div class="box-body">
            <div class="row">
                <div class="form-group col-lg-12 col-xs-6 mb-4">
                    <h5 style="padding-left:20px;"> Nama : <?=$nama_mahasiswa?></h5>
                    <h5 style="padding-left:20px;"> NIM : <?=$nim_mahasiswa?></h5>
                    <h5 style="padding-left:20px;"> Kelas : <?=$kelas_mahasiswa?></h5>
                </div>
                <div class="box-body">
                    <div class="row"> 
                        <div class="form-group col-lg-2 col-xs-4 text-center" style="margin: 0 auto; padding-left: 40px; width: 300px;">
                            <div class="alert bg-blue">
                                <h5>Total Waktu Percobaan</i></h5>
