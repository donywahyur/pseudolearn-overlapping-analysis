                ...
                <tr>
                    ...
                    <td>
                        <div class="text-center">
                            <a class="btn btn-xs btn-warning tombol-hapus" style="color: #fff;" href="'.base_url().'manajemenhistory/hapus/'.$u['iduser'].'/'.$u['idsoal'].'">
                            <i class="fa fa-unlock" style="color: #fff;"></i> Unlock
                            </a> 
                        </div>
                    </td>
                </tr>';
        ...
        confirmButtonText: "Unlock!"
         ...
         if (result.value) {
             ...
             Swal({
                    ...
                    text: data.status
                        ? "Data soal berhasil di-unlock"
                        : "Data soal gagal di-unlock",
